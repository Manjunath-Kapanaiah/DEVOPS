  ...
  simple-check:
    ...
    steps:
      ...
      - name: Code Quality Check
        run: |
          echo "Scanning files for issues..."
          ls -R
          echo "All files are present and accounted for."
...
----------------------------------------------------------------------
TASK 12: BLAME FOR DEBUGGING

----------------------------------------------------------------------
git blame .github/workflows/ci.yml


git blame -w .github/workflows/ci.yml - ignores whitespaces


git show 5c12e65 >>  we can dig deeper into why the change was made by looking at the full commit message: